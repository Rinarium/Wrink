...
## Содержание
  ...
  3. [Варианты использования](#3) <br>
    ...
    3.7 [Оценить информацию](#3.7) <br>
    3.8 [Оставить комментарий](#3.8) <br>
    3.9 [Изменить персональные данные](#3.9) <br>
    3.10 [Удалить профиль](#3.10) <br>
    3.11 [Удалить чужую информацию](#3.11) <br>
...
### 3.7 Оценить информацию<a name="3.7"></a>
...
### 3.8 Оставить комментарий<a name="3.8"></a>
...
### 3.9 Изменить персональные данные<a name="3.9"></a>
...
### 3.10 Удалить профиль<a name="3.10"></a>
...
### 3.11 Удалить чужую информацию<a name="3.11"></a>
**Описание:** вариант использования "Удалить чужую информацию" позволяет администратору удалить чужую информацию.
